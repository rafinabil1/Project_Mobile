        ...
        child: Column(
          children: [
            ...
            Container(
              height: 300,
              child: Image.asset(
                'assets/HandyMen 207 Sepatu Kulit Formal.png', // Ganti dengan URL gambar asli
                fit: BoxFit.cover,
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'HandyMen 207 Sepatu Kulit Formal',
                    style: TextStyle(
                      fontSize: 20,
                  ...
                  SizedBox(height: 8),
                  Text(
                    'low cut slip on dress shoes yang didesain safety '
                    'velcrow strap. Neat stitching dengan bahan mile '
                    'leather (garansi kulit asli) yang dilengkapi laminasi'
                    'sporty lining bagian dalam sepatu. Digunakan'
                    'untuk aktivitas lapangan, pekerjaan berat,'
                    'biker, pendaki formal, security dan lain-lain',
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.to(KeranjangHm2View()); // Navigasi ke halaman keranjang
                      },
                      child: Container(
